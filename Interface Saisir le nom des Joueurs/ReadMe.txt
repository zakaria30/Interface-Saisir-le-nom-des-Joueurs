================================================================================
    BIBLIOTHÈQUE MFC (MICROSOFT FOUNDATION CLASS) : Vue d'ensemble du projet Interface Saisir le nom des Joueurs
===============================================================================

L'Assistant Application a créé cette application Interface Saisir le nom des Joueurs pour vous. Cette application décrit non seulement les bases de l'utilisation de Microsoft Foundation Classes, mais est également un point de départ pour l'écriture de votre application.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application Interface Saisir le nom des Joueurs.

Interface Saisir le nom des Joueurs.vcxproj
...
Interface Saisir le nom des Joueurs.vcxproj.filters
...
Interface Saisir le nom des Joueurs.h
    Il s'agit du fichier d'en-tête principal pour l'application.
    Il comprend d'autres en-têtes spécifiques au projet (notamment Resource.h) et déclare la classe d'application CInterfaceSaisirlenomdesJoueursApp.

Interface Saisir le nom des Joueurs.cpp
    Il s'agit du fichier source principal de l'application qui contient la classe d'application CInterfaceSaisirlenomdesJoueursApp.

Interface Saisir le nom des Joueurs.rc
...
res\Interface Saisir le nom des Joueurs.ico
    Il s'agit d'un fichier icône, qui est utilisé comme icône de l'application. Cette icône est incluse par le fichier de ressources principal Interface Saisir le nom des Joueurs.rc.

res\InterfaceSaisirlenomdesJoueurs.rc2
...
Interface Saisir le nom des JoueursDlg.h, Interface Saisir le nom des JoueursDlg.cpp - la boîte de dialogue
    Ces fichiers contiennent votre classe CInterfaceSaisirlenomdesJoueursDlg. Cette classe définit le comportement de la boîte de dialogue principale de votre application. Le modèle de la boîte de dialogue se trouve dans Interface Saisir le nom des Joueurs.rc, qui peut être modifié dans Microsoft Visual C++.
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) Interface Saisir le nom des Joueurs.pch et un fichier de type précompilé nommé StdAfx.obj.
...
Interface Saisir le nom des Joueurs.manifest
