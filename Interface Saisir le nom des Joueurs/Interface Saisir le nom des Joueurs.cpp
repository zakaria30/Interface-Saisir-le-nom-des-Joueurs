...
// Interface Saisir le nom des Joueurs.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CInterfaceSaisirlenomdesJoueursApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CInterfaceSaisirlenomdesJoueursApp

CInterfaceSaisirlenomdesJoueursApp::CInterfaceSaisirlenomdesJoueursApp()
{
...
// Seul et unique objet CInterfaceSaisirlenomdesJoueursApp

CInterfaceSaisirlenomdesJoueursApp theApp;


// initialisation de CInterfaceSaisirlenomdesJoueursApp

BOOL CInterfaceSaisirlenomdesJoueursApp::InitInstance()
{
	...
	CInterfaceSaisirlenomdesJoueursDlg dlg;
	m_pMainWnd = &dlg;
